...
--> statement-breakpoint
ALTER TABLE "tweets" DROP CONSTRAINT "tweets_post_id_epoch_unique";--> statement-breakpoint
...
ALTER TABLE "support_conversations" ADD CONSTRAINT "support_conversations_assigned_admin_id_users_id_fk" FOREIGN KEY ("assigned_admin_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tweets" ADD CONSTRAINT "tweets_post_id_unique" UNIQUE("post_id");