...
CREATE TABLE "campaigns" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "campaigns_pkey" PRIMARY KEY("project_id","index"),
...
CREATE TABLE "epochs" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "epochs_pkey" PRIMARY KEY("project_id","campaign_index","index"),
...
CREATE TABLE "rewards" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "rewards_pkey" PRIMARY KEY("project_id","campaign_index","amount","token"),
...
CREATE TABLE "user_epoch_scores" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "user_epoch_scores_pkey" PRIMARY KEY("project_id","campaign_index","epoch_index","user_id"),
