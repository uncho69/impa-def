  ...
  return (
    <div className="relative z-10">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">Mercati di Predizione</h1>
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            Piattaforme di scommesse e previsioni su eventi futuri in ambito Web3
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <span>📈</span>
            <span>Intro ai Mercati di Predizione</span>
          </button>
          <Link
            href="/news/gaming"
      ...
      <div className="relative mb-8 max-w-2xl">
        ...
        <input
          type="search"
          placeholder="Cerca app per scommesse e prediction markets"
          value={search}
      ...
      <main className="flex-1 min-w-0">
        ...
        {filteredApps.length === 0 && (
          <p className="text-center py-12 text-slate-500 dark:text-slate-400">
            Nessuna app trovata per i filtri selezionati.
          </p>
        )}
      </main>
