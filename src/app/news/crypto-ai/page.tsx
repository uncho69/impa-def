      ...
      <div className="bg-gradient-to-br from-cyan-50 via-white to-blue-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Crypto AI News</h1>
            <p className="text-gray-600">Intelligenza artificiale e blockchain unite</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Nessun articolo Crypto AI</h3>
