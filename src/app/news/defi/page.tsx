      ...
      <div className="bg-gradient-to-br from-green-50 via-white to-emerald-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center mx-auto mb-4">
              <Image 
                src={ethereumIcon} 
                alt="DeFi"
                width={32}
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">DeFi News</h1>
            <p className="text-gray-600">Ultime novità dalla finanza decentralizzata</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Nessun articolo DeFi</h3>
