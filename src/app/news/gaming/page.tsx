      ...
      <div className="bg-gradient-to-br from-violet-50 via-white to-purple-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Giochi & Mercati di Predizione, P2E e l'evoluzione del gaming blockchain</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Nessun articolo Gaming</h3>
