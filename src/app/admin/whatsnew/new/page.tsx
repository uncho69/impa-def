...
export default function NewWhatsNewCardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Errore nella creazione della card');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Nuova Card Novità</h1>
          <p className="text-gray-600 mt-2">Crea una nuova card per la sezione "Cosa c'è di nuovo"</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md border border-gray-200 p-8 space-y-6">
        ...
        <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
          ...
          >
            ...
            {loading ? 'Salvataggio...' : 'Salva Card'}
          </button>
        </div>
      </form>
    </div>
