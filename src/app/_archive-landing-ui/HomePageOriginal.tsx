/**
 * ARCHIVIO: vecchia landing page (pre-redesign dashboard dark).
 * Non usata nelle route. Per ripristino copiare in src/app/page.tsx.
 */
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4 text-neutral-700 leading-relaxed text-lg">
                      <p>I problemi di fiducia sono il motivo per cui le blockchain sono state create; è stato Bitcoin, e la mancanza di fiducia dei suoi creatori nei confronti dei sistemi monetari tradizionali sostenuti dai governi (fiat: USD, EUR, JPY, ecc.) ad accendere per la prima volta la fiamma di questa rivoluzione decentralizzata.</p>
                      <p>Come sappiamo, la blockchain di Bitcoin, soprattutto all&apos;epoca, era ancora limitata a essere principalmente un buon deposito di valore, sotto forma di valuta BTC, che i miner potevano produrre nei loro garage e guadagnare qualcosa. Non durò a lungo (la parte del garage), poiché presto si scoprì che le ricompense (i blocchi) erano limitate: man mano che venivano utilizzate sempre più GPU per il mining, non era più possibile farlo con i normali computer di casa, ma bisognava allestire strutture più grandi e complesse per minare BTC.</p>
                      <p>Le tecnologie Web3 hanno la capacità di migliorare la vita delle persone quando funzionano correttamente e quando gli utenti sanno cosa stanno facendo. Sfortunatamente, il settore ha avuto una barriera d&apos;ingresso relativamente alta per chi non è esperto di tecnologia, le persone comuni.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-red-100 transition-all duration-500 group relative">
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 text-neutral-700 leading-relaxed">
                    <p>Quando una persona nuova nel mondo Web3 cerca di capire di più sull&apos;ecosistema per eventualmente entrarvi, si trova di fronte a:</p>
                    <div className="grid grid-cols-1 gap-2">
                      {["Milioni di Token", "Centinaia di blockchain", "Migliaia di NFT", "Complesità tecniche", "Truffatori e rischi di phishing"].map((item, i) => (
                        <div key={i} className="flex items-center gap-3 p-3 bg-red-50 rounded-lg hover:bg-red-100 transition-all duration-200">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-green-100 transition-all duration-500 group relative">
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 text-neutral-700 leading-relaxed">
                    <p>Imparodefi consentirà ai nuovi aspiranti utenti Web3 di imparare esclusivamente da progetti realmente validi, selezionati dalle persone migliori per questo compito: veri esperti Web3 forgiati &quot;sul campo&quot;.</p>
                    <div className="bg-green-50 border border-green-200 rounded-xl p-4 hover:bg-green-100 transition-all duration-300 group-hover:shadow-lg">
                      <p className="text-green-800 font-semibold text-center">Curazione fatta da veri esperti Web3</p>
                    </div>
                    <p>Gli esperti Web3 si trovano in comunità di nicchia; dal DeFi agli NFT, pochi gruppi si distinguono. Ogni comunità è governata da un token (o NFT), e i possessori di questi asset dimostrano reale coinvolgimento avendo speso i propri soldi per ottenerli.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-10 border border-blue-100 transition-all duration-500 relative group">
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="space-y-4 text-neutral-700 leading-relaxed">
                    <p>I possessori degli NFT Shroomiez saranno inizialmente coloro che guideranno il progetto, votando quali progetti aggiungere, rimuovere o mantenere su Imparodefi.</p>
                    <p>I membri della community che governano ImparoDeFi decideranno anche come distribuire il budget di ogni progetto tra creatori e promotori.</p>
                  </div>
                  <div className="space-y-4 text-neutral-700 leading-relaxed">
                    <p>In futuro, gli smart contract potranno essere aggiornati per permettere ad altre collezioni NFT o community di Token di partecipare alla governance di ImparoDeFi, permettendo a qualsiasi altra comunità di contribuire.</p>
                    <a href="/sign-in" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl mt-6">
